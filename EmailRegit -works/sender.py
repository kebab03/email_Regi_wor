...
def toggle():
    ...
    #num_buttonsp=request.args.get(num_buttons)
    #print(f"num_buttonsp:={num_buttonsp}")
...
def get_state():
    ...
    for i in range(1, num_buttons + 1):
        ...
        print("button_id in get state di root state",button_id)
...
button_states = {'on'}  # Store the state of each button
